...
import { ComposableMap, Geographies, Geography, ZoomableGroup, Graticule, Sphere, Marker } from "react-simple-maps";
...
const getRandomColor = () => {
  ...
  const saturation = 70 + Math.random() * 20; // Keep saturation high for bright colors
  const lightness = 85 + Math.random() * 10;  // Keep lightness high for pastel effect
...
const MapWorld = () => {
  ...
  const animals = [
    { name: "Elephant", coordinates: [20, -30], icon: "🐘" },
    { name: "Lion", coordinates: [10, -20], icon: "🦁" }
  ];
  ...
  const markers = [
    ...
    { markerOffset: 15, name: "La Paz", coordinates: [-68.1193, -16.4897], icon: "🦁" },
    { markerOffset: 15, name: "Brasilia", coordinates: [-47.8825, -15.7942], icon: "🐘" },
    { markerOffset: 15, name: "Santiago", coordinates: [-70.6693, -33.4489], icon: "🐘" },
    { markerOffset: 15, name: "Bogota", coordinates: [-74.0721, 4.711], icon: "🐘" },
    { markerOffset: 15, name: "Quito", coordinates: [-78.4678, -0.1807], icon: "🐘" },
    { markerOffset: -30, name: "Georgetown", coordinates: [-58.1551, 6.8013], icon: "🐘" },
    { markerOffset: -30, name: "Asuncion", coordinates: [-57.5759, -25.2637], icon: "🐘" },
    { markerOffset: 15, name: "Paramaribo", coordinates: [-55.2038, 5.852], icon: "🐘" },
    { markerOffset: 15, name: "Montevideo", coordinates: [-56.1645, -34.9011], icon: "🐘" },
    { markerOffset: 15, name: "Caracas", coordinates: [-66.9036, 10.4806], icon: "🐘" },
    { markerOffset: 15, name: "Lima", coordinates: [-77.0428, -12.0464], icon: "🐘" }
  ];
  ...
  return (
    ...
    >
      ...
      {/*{markers.map(({ name, coordinates, markerOffset, icon }) => (*/}
      {/*  <Marker key={name} coordinates={coordinates}>*/}
      {/*      <g id="Elephant_1_" width={10}>*/}
      {/*      <circle cx="54.5423508" cy="24.7482376" r="1.50615"/>*/}
      {/*      <path d="M54.2569504,12.4205885l-0.1817017-0.0743008h-6.9149971c-0.9990005-0.9422998-4.1445007-3.5165997-7.3652-2.0985994*/}
